...
Namespace WinDesignerDashboardState
	Partial Public Class DesignerForm1
		...
		Private Sub InitializeComponent()
			...
			' dashboardDesigner
			' 
			Me.dashboardDesigner.Appearance.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(240))))), (CInt(Fix((CByte(240))))), (CInt(Fix((CByte(240))))))
...
'			Me.dashboardDesigner.CustomizeDashboardTitle += New DevExpress.DashboardWin.CustomizeDashboardTitleEventHandler(Me.dashboardDesigner_CustomizeDashboardTitle);
			' 
			' DesignerForm1
			' 
